...
export default function Lanyard({
  ...
  return (
    <div className="relative z-0 flex justify-center items-center" style={{ width: "100%", height: "100%" }}>
      <Canvas
        camera={{ position, fov }}
...
function Band({
  ...
  const texture = useTexture(lanyardImage || lanyard, (t) => {
  ...
  const cardMap = useMemo(() => {
    ...
    if (frontImage && frontTex.image) drawFitted(frontTex.image as unknown as HTMLImageElement, FRONT_UV_RECT);
    if (backImage && backTex.image) drawFitted(backTex.image as unknown as HTMLImageElement, BACK_UV_RECT);
